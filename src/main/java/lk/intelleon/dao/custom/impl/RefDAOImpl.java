...
public class RefDAOImpl implements RefDAO {
    ...
    @Override
    public ResultSet generateRefId() throws SQLException, ClassNotFoundException {
        return CrudUtil.execute( "SELECT refid FROM Ref ORDER BY refid DESC LIMIT 1" );
    }
